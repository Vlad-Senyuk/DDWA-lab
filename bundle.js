...
var _accounts = __webpack_require__(35);

var _creator = __webpack_require__(45);

var _crud = __webpack_require__(46);

var _nav = __webpack_require__(47);

var _validation = __webpack_require__(61);

var _table_help = __webpack_require__(48);
...
var NavigationHelper = exports.NavigationHelper = function () {
	...
	(0, _createClass3.default)(NavigationHelper, [{
		...
		value: function () {
								...
								return myApp.collectionHelperCRUD.getAllAccounts().then(function (body) {
									...
									$(document).ready(function () {
										...
										var table = $('#shortTableOfAccounts').DataTable({
											data: body,
											columns: [{ data: 'accountNumber', className: 'info' }, { data: 'accountBalance' }, { data: 'dateOfAccountCreation', render: function render(data, type, row) {
													return data.substring(0, 10);
												} }, { data: 'accountType' }, { data: 'accountUser' }, {
			...
			function fillTableForIndex() {
				return _ref.apply(this, arguments);
			}

			return fillTableForIndex;
		}()
	}, {
		key: 'detailsOnLoadOverride',
		value: function detailsOnLoadOverride(paramValue) {
			myApp.collectionHelperCRUD.getAccountById(paramValue).then(function (body) {
				myApp.tableHelper.fillDetailsTable(body);
			});
		}
	}, {
		key: 'createAccOnLoadOverride',
		value: function createAccOnLoadOverride(paramValue) {
			myApp.collectionHelperCRUD.getAccountById(paramValue).then(function (body) {
				myApp.navigationHelper.fillAccountFields(body);
			});
		}
	}]);
...
module.exports = !__webpack_require__(38) && !__webpack_require__(67)(function () {
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(66)(Function.call, __webpack_require__(148).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(15)(proto, TO_PRIMITIVE, __webpack_require__(335));
...
$export($export.P + $export.F * (__webpack_require__(70) != Object || !__webpack_require__(23)(arrayJoin)), 'Array', {
